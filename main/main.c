...
esp_err_t set_pwm(void){
	...
	ledc_channel_config_t channelConfigR={};
	...
	ledc_channel_config_t channelConfigG={};
	...
	ledc_channel_config_t channelConfigB={};
